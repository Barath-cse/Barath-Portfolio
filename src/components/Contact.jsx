        ...
        >
          <div className="contact-info" style={{ marginTop: 0 }}>
            <div className="signal-cards-container">
              {/* Email Card */}
              <a href="mailto:barathash77@gmail.com" className="signal-card-row">
                <div className="s-icon-box purple-box">
                  <Mail size={18} />
                </div>
                <div className="s-card-info">
                  <span className="s-label">EMAIL</span>
                  <span className="s-val">barathash77@gmail.com</span>
                </div>
                <div className="s-arrow">→</div>
              </a>

              {/* Phone Card */}
              <a href="tel:+917010733225" className="signal-card-row">
                <div className="s-icon-box cyan-box">
                  <Phone size={18} />
                </div>
                <div className="s-card-info">
                  <span className="s-label">PHONE</span>
                  <span className="s-val">+91 70107 33225</span>
                </div>
                <div className="s-arrow">→</div>
              </a>

              {/* LinkedIn Card */}
              <a href="https://linkedin.com/in/barath-k-564403377" target="_blank" rel="noreferrer" className="signal-card-row">
                <div className="s-icon-box purple-box font-icon">
                  in
                </div>
                <div className="s-card-info">
                  <span className="s-label">LINKEDIN</span>
                  <span className="s-val">linkedin.com/in/barath-k</span>
                </div>
                <div className="s-arrow">→</div>
              </a>

              {/* GitHub Card */}
              <a href="https://github.com/Barath-cse" target="_blank" rel="noreferrer" className="signal-card-row">
                <div className="s-icon-box coral-box font-icon">
                  gh
                </div>
                <div className="s-card-info">
                  <span className="s-label">GITHUB</span>
                  <span className="s-val">github.com/Barath-cse</span>
                </div>
                <div className="s-arrow">→</div>
              </a>
            </div>
