...
const hexSkills = [
  { id: '01', name: 'PYTHON', level: 90 },
  { id: '02', name: 'JAVA', level: 85 },
  { id: '03', name: 'REACT.JS', level: 80 },
  { id: '04', name: 'NODE.JS', level: 85 },
  { id: '05', name: 'MONGODB', level: 80 },
  { id: '06', name: 'SPRING BOOT', level: 75 },
  { id: '07', name: 'SQL', level: 85 },
  { id: '08', name: 'C', level: 80 },
  { id: '09', name: 'GIT & GITHUB', level: 90 },
];
